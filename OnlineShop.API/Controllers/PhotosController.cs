...
{
    [Route("api/products/{idProduct}/photos")]
    [ApiController]
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(IShoppingRepository repo, IMapper mapper,
        ...
        [HttpPost("{id}/setMain")]
        public async Task<IActionResult> SetMainPhoto(int idProduct, int id)
        {
            var product = await _repo.GetProduct(idProduct);
            ...
            var currentMainPhoto = await _repo.GetMainPhotoForProduct(idProduct);
